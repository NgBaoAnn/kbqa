...
# Loaded lazily from src/prompts/text_to_cypher.md at import time.
# Keeping the name SCHEMA_PROMPT for backward-compatibility with existing callers.
SCHEMA_PROMPT: str = load_prompt("text_to_cypher")
