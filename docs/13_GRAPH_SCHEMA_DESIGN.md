...
- [ ] Chạy `PYTHONPATH=$PWD python etl/graph_builder/build_graph.py --dry-run` (kiểm tra data)
- [ ] Chạy `PYTHONPATH=$PWD python etl/graph_builder/build_graph.py --clear` (import thật)
